            ...
            <div class="card ">
                <div class="card-header ">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="/admin/categories/<?php echo e($product->category->id); ?>/"><?php echo e($product->category->name); ?></a>
                        </li>
                        <li class="breadcrumb-item">
                    ...
                    <div class="card-header">
                        <h6 class="card-title"> MODIFIER PRODUIT <strong><?php echo e($product->name); ?></strong></h6>
                    </div>
                </div>
                <div class="card-body ">
